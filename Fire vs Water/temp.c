    ...
    for(int count=0; count!=simCount ; count++){
       ...
       // for (int i=0;i<no_fire;i++){printf("%d    %d\n",stor_fire[no_fire][0]=-1,stor_fire[no_fire][1]=-1 );};
        ...
        for (int g=0;g<no_fire;g++){
            ...
            if (grid[ x +a ][  y  +b  ] == box1 && check(x+a, y+b,  num_fire, stor_fire)){
                grid[x+a][y+b] = box2;
                num_fire++;
            ...
            }else if(grid[x+a][y+b] == box3 && check(x+a, y+b,  num_fire, stor_fire)){
                grid[x+a][y+b] = box4;
                num_fire++;
                 stor_fire[num_fire][0]=x +a;
                 stor_fire[num_fire][1]=y +b;
                
            }else if(grid[x-1][y] == box1 && check(x-1, y,  num_fire, stor_fire)){
                grid[x-1][y] = box2;
                num_fire++;
                 stor_fire[num_fire][0]=x -1;
                 stor_fire[num_fire][1]=y ;
                
            }else if(grid[x-1][y] == box3 && check(x-1, y,  num_fire, stor_fire)){
                grid[x-1][y] = box4;
                num_fire++;
                 stor_fire[num_fire][0]=x -1;
                 stor_fire[num_fire][1]=y ;
            ...
            }else if(grid[x][y+1] == box1 && check(x, y+1,  num_fire, stor_fire)){
                grid[x][y+1] = box2;
                num_fire++;
                 stor_fire[num_fire][0]=x ;
                 stor_fire[num_fire][1]=y +1;
                
            }else if(grid[x][y+1] == box3 && check(x, y+1,  num_fire, stor_fire)){
                grid[x][y+1] = box4;
                num_fire++;
                 stor_fire[num_fire][0]=x ;
                 stor_fire[num_fire][1]=y +1;
        ...
        for (int i=0;i<no_water;i++){stor_water[no_water][0]=-1;stor_water[no_water][1]=-1 ;};
        ...
        for (int g=0;g<no_water;g++){
            ...
            if (grid[ x +a ][  y  +b  ] == box1 && check(x+a, y+b,  num_water, stor_water)){
                grid[x+a][y+b] = box2;
                num_water++;
            ...
            }else if(grid[x+a][y+b] == box3 && check(x+a, y+b,  num_water, stor_water)){
                grid[x+a][y+b] = box4;
                num_water++;
                stor_water[num_water][0]=x +a;
                stor_water[num_water][1]=y +b;
            ...
            }else if(grid[x-1][y] == box1 && check(x-1, y,  num_water, stor_water)){
                grid[x-1][y] = box2;
                num_water++;
                stor_water[num_water][0]=x -1;
                stor_water[num_water][1]=y ;
                
            }else if(grid[x-1][y] == box3 && check(x-1, y,  num_water, stor_water)){
                grid[x-1][y] = box4;
                num_water++;
                stor_water[num_water][0]=x -1;
                stor_water[num_water][1]=y ;
            ...
            }else if(grid[x][y+1] == box1 && check(x, y+1,  num_water, stor_water)){
                grid[x][y+1] = box2;
                num_water++;
                stor_water[num_water][0]=x ;
                stor_water[num_water][1]=y +1;
                
            }else if(grid[x][y+1] == box3 && check(x, y+1,  num_water, stor_water)){
                grid[x][y+1] = box4;
                num_water++;
                stor_water[num_water][0]=x ;
                stor_water[num_water][1]=y +1;
